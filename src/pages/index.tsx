...
export default function Home() {
  ...
  const { account, contract, isWalletConnected, connectWallet, mintMember, createFight, joinAndFight, trainFighter } = OCFC;
  ...
  return (
    <div>
      ...
      <header className='w-full bg-[#24123b] h-20 p-2 align-center flex'>
        ...
        <div className='right-header m-auto justify-end w-6/12 h-full flex'>
          <WalletConnected account={account} isWalletConnected={isWalletConnected} onClick={connectWallet} className="ml-10" />
        </div>
      </header>
      <main>
      </main>
